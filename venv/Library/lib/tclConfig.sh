...
# installed.
TCL_PREFIX='D:/ML_Projects/01_Regression/02_Regression_HousePricePrediction/venv\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='D:/ML_Projects/01_Regression/02_Regression_HousePricePrediction/venv\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='D:/ML_Projects/01_Regression/02_Regression_HousePricePrediction/venv\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-ID:/ML_Projects/01_Regression/02_Regression_HousePricePrediction/venv\Library\include'
...
TCL_PACKAGE_PATH='D:/ML_Projects/01_Regression/02_Regression_HousePricePrediction/venv\Library\lib'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LD:/ML_Projects/01_Regression/02_Regression_HousePricePrediction/venv\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='D:/ML_Projects/01_Regression/02_Regression_HousePricePrediction/venv\Library\lib\tclstub86.lib'
